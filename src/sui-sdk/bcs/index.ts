...
export class BcsReader {
   ...
   */
  read128(): BN {
    const value1 = this.read64();
    const value2 = this.read64();
    const result = value2.toString(16) + value1.toString(16).padStart(8, '0');
...
export class bcs {
   ...
   */
  public static ser(type: string, data: any, size = 1024): BcsWriter {
  ...
  public static registerEnumType(
    ...
    return this.registerType(
      ...
      (writer: BcsWriter, data: {[key: string]: any | null}) => {
        ...
        const invariantType = struct[invariant];
  ...
  static getTypeInterface(type: string): TypeInterface {
    const typeInterface = bcs.types.get(type);
